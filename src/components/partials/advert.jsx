    ...
    <div className="container col-xxl-8 px-4 py-5 resources">
      <div className="accordion" role="tablist" id="accordion-1">
          ...
          >
            <div className="accordion-body">
              <ol style={{ marginTop: 10 }}>
                ...
                <li>
                  Though EdaFace strives to prevent scams, users are advised to
                  do their own research before using any project. See EdaFace
                  full
                  <br />
                ...
                <li>
                  ...
                  fill in this form and submit for the Project to be advertised
                  on EdaFace Newsfeed Platform.
                  <br />
                </li>
                <li>
                  If you have all the required 11 Parameters ready, the process
                  of Submission takes about 10 minutes.
                </li>
              </ol>
            </div>
          </div>
        ...
        >
          ...
          >
            <div className="accordion-body">
              <p className="mb-0" style={{ marginTop: 10, fontWeight: "bold" }}>
              ...
              <p className="mb-0" style={{ marginTop: 10 }}>
                (a). Interactive media links, e.g. Facebook, Telegram, Twitter,
                Instagram, etc.
                <br />
              </p>
              <p className="mb-0" style={{ marginTop: 10 }}>
              ...
              <p className="mb-0" style={{ marginTop: 10 }}>
                EdaFace will need to confirm which company owns the Project you
                are submitting.
                <br />
              </p>
              <p className="mb-0" style={{ marginTop: 10 }}>
              ...
              <p className="mb-0" style={{ marginTop: 10 }}>
                <strong>(7). Proof of Company Registration Certificate</strong>
                <br />
              </p>
              <p className="mb-0" style={{ marginTop: 10 }}>
              ...
              <p className="mb-0" style={{ marginTop: 10 }}>
                Note that only email address of the Project website is accepted,
                e.g. <a href="mailto:sales@edaface.com">sales@edaface.com</a>.
                No public email such as yahoo mail, gmail, etc. will be
                accepted.
                <br />
              </p>
              <p className="mb-0" style={{ marginTop: 20 }}>
              ...
              <ul style={{ marginTop: 10 }}>
                <li>
                  Before you click on the Submission Button, please be sure that
                  ALL the above<strong> 10 Required Parameters</strong> f
                  <strong>
                    or Advertisement&nbsp;on EdaFace Newsfeed Platform{" "}
                  </strong>
              ...
              <ul style={{ marginTop: 10 }}>
                ...
                <li>
                  Enhanced Google search engine optimization for EdaFace website
                </li>
                <li>
